...
interface ScheduleModalProps {
  ...
  open: boolean
  onClose: () => void
  onConfirm: (date: string, time: string, serviceType: string, notes: string) => void
}

export function ScheduleModal({ ticket, open, onClose, onConfirm }: ScheduleModalProps) {
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px] bg-card border-border">
        <DialogHeader>
          ...
          <DialogDescription>Configure o agendamento para o chamado {ticket.number}</DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-2">
            ...
            <Select value={serviceType} onValueChange={setServiceType}>
              ...
              <SelectContent>
                ...
                <SelectItem value="onsite">Atendimento Presencial</SelectItem>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleConfirm} disabled={!date || !time || !serviceType}>
