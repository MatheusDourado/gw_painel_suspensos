      ...
      <header className="sticky top-0 z-50 border-b border-border bg-sidebar px-6 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-semibold text-foreground">Dashboard Chamados Suspensos</span>
          ...
          <div className="space-y-4">
                ...
                >
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge
                        ...
                        className={
                          normalizePriority(ticket.priority) === "critica"
                            ...
                            : normalizePriority(ticket.priority) === "alta"
                      ...
                      <Badge variant="secondary">{ticket.environment}</Badge>
                    </div>
                    <p className="text-sm text-foreground">{ticket.title}</p>
                    <p className="text-xs text-muted-foreground">
                      Cliente: {ticket.client} | Analista: {ticket.analyst}
                    </p>
                  </div>
            ...
            {!searchQuery && (
              <div className="py-4 text-center text-sm text-muted-foreground">
                Digite para buscar por numero, titulo, cliente, analista ou ambiente
              </div>
            )}
          </div>
        </DialogContent>
